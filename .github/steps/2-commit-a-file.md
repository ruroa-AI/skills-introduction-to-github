...
2. **Add file** ドロップダウンを選択し、**Create new file** をクリックします。
   ...
   <img width="300" alt="screenshot of the create new file option" src="https://github.com/ruroa-AI/skills-introduction-to-github/blob/main/.github/images/create-new-file-option.png?raw=true">
...
4. **Enter file contents here** のエリアに、次の内容をコピーしてファイルに貼り付けます。
   ...
   ![screenshot for adding the profile.md file](https://github.com/ruroa-AI/skills-introduction-to-github/blob/main/.github/images/add-profile-file.png?raw=true)
...
6. GitHub は簡単なデフォルトメッセージを提案してくれますが、練習のため少し変更してみましょう。**Commit message** フィールドに `Add PROFILE.md` と入力します。
   ...
   <img width="400" alt="screenshot of adding a new file with a commit message" src="https://github.com/ruroa-AI/skills-introduction-to-github/blob/main/.github/images/commit-message-dialog.png?raw=true">
